SELECT DISTINCT(genes_id_mapping.ensembl_id) AS id, genes.gene_desc, group_concat(distinct pathways.path_desc SEPARATOR '\\n') as pathway, group_concat(distinct pathways.path_url SEPARATOR '\\n') as urls, genes_id_mapping.ncbi_id
              FROM genes
              ...
              WHERE genes_id_mapping.ncbi_id in ("839523", "839106", "838517") Group By id, genes.gene_desc, genes_id_mapping.ncbi;