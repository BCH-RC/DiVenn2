...
<!--the table below is for zoom graph-->
...
<div class="container">
    ...
    <script>
        var nodes = [
            {"id": "Perdeep", "group": 1},
            {"id": "Fuqi Liao", "group": 1},
            {"id": "Liang Sun", "group": 1},
            {"id": "Sufen Dong", "group": 1},
            {"id": "Nick Krom", "group": 1},
            {"id": "Junil Chang", "group": 1},
            {"id": "Soonil Kwon", "group": 1},
            {"id": "Sandy", "group": 1},
            {"id": "Ashley", "group": 1},
            {"id": "OldMan", "group": 1},
            {"id": "Labarre", "group": 2},
        ...
        var links = [
            {"source": "Fuqi Liao", "target": "Perdeep", "value": 1},
            {"source": "Liang Sun", "target": "Perdeep", "value": 8},
            {"source": "Sufen Dong", "target": "Perdeep", "value": 10},
            {"source": "Sufen Dong", "target": "Liang Sun", "value": 6},
            {"source": "Nick Krom", "target": "Perdeep", "value": 1},
            {"source": "Junil Chang", "target": "Perdeep", "value": 1},
            {"source": "Soonil Kwon", "target": "Perdeep", "value": 1},
            {"source": "Sandy", "target": "Perdeep", "value": 1},
            {"source": "Ashley", "target": "Perdeep", "value": 2},
            {"source": "OldMan", "target": "Perdeep", "value": 1},
            {"source": "Valjean", "target": "Labarre", "value": 1},
            {"source": "Valjean", "target": "Sufen Dong", "value": 3},
            {"source": "Valjean", "target": "Liang Sun", "value": 3},
            {"source": "Valjean", "target": "Perdeep", "value": 5},
        ...
        var link = svg.append("g")
            ...
            .selectAll("line")
            .data(links)                       //获得link数据
            .enter().append("line")             //画线
            .attr("stroke-width", function (d) {
                return Math.sqrt(d.value);
            })
            .attr("stroke", palette.gray)      //线的颜色
            .attr("stroke-opacity", .6)        //线的透明度

        /*var node = svg.append("g")               //添加g节点
              .attr("class","nodes")
              .selectAll("circle")
              .data(nodes).enter()               //链接数据
              .append("circle")                  //添加圆
              .attr("r",circleWidth)             //设置圆的半径
              .attr("fill",function(d){ return color(d.group);})       //圆点的填充颜色
              .call(d3.drag()
        ...
        var nodetext = node.append("text")                       //为每个节点添加文本
            .text(function (d) {
                return d.id
            })                    //获得node数据中的id值
