...
def DiVenn2_preprocess_seuratobj(adata, cell_type_col, condition_col, logfc_threshold, min_pct, p_val_adj_thd, output_file):
...
def main():
    ...
    DiVenn2_preprocess_seuratobj(adata, args.group, args.condition, args.logfc_threshold, args.min_pct, args.p_val_adj_thd, args.output)
