...
def main():
    ...
    parser.add_argument("-c", "--condition", type=str, required=True, help="Sample Condition (disease/normal condition)")
    parser.add_argument("-g", "--group", type=str, required=True, help="Cell Group (cell type)")
    parser.add_argument("-o", "--output", type=str, default=None, help="Preprocessed DEG output File")
    parser.add_argument("-f", "--logfc_thd", type=float, default=0.2, help="Log fold change threshold (default: 0.2)")
